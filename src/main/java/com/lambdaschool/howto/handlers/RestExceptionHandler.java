package com.lambdaschool.howto.handlers;
...
import com.lambdaschool.howto.models.ErrorDetail;
import com.lambdaschool.howto.services.HelperFunctions;
    ...
    extends ResponseEntityExceptionHandler
{
        ...
        WebRequest request)
    {
        ...
        errorDetail.setTimestamp(new Date());
        errorDetail.setStatus(status.value());
        errorDetail.setTitle("HELLO FROM THE BACKEND! - Rest Endpoint Not Valid");
